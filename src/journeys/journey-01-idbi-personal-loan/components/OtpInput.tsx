...
export interface OtpInputProps {
  /** Number of digit boxes. Defaults to 6 (this journey's OTP length). */
  length?: number;
...
/**
 * Reusable 6-digit OTP entry (journey-local; reused by Screens 3, 4, 5 and
 * 13 of this journey's Customer Flow). Individual digit boxes with
 * auto-advance on type, backspace-to-previous, arrow-key navigation, and
 * paste support for a full code pasted into any box.
 */
function OtpInput({
  length = 6,
  value,
